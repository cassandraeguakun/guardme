                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="nav nav-tabs" id="myTab">
                            <li class="active"><a href="#inbox" data-toggle="tab"><span
                                            class="lnr lnr-user blok"></span> Freelancer Profile</a></li>
                            <li><a href="#sent" data-toggle="tab"><span class="lnr lnr-apartment blok"></span> Employer
                                    Profile</a></li>
                            <li><a href="#assignment" data-toggle="tab"><span class="lnr lnr-star blok"></span> Reviews</a>
                            </li>
							...
							My Account </a>
                                                ...
                                                <div class="profile-content">
                                                    ...
                                                    <div class="panel-body">
                                                        <div class="alert alert-warning" role="alert">
                                                            Please complete your profile below. You will only be
                                                            eligible to apply for work after your profile is complete
                                                            and your documents are approved.
                                                        </div>
                                                        <div id="progressbar"></div>

                                                        <form class="form-horizontal" role="form" method="POST"
                                                              action="{{ route('dashboard') }}" id="formID"
                                                                ...
                                                                <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="name" type="text"
                                                                               class="trackprogress form-control validate[required] text-input"
                                                                               name="name"
                                                                               value="<?php echo $editprofile[0]->name;?>"
                                                                               autofocus>
                                                                        @if ($errors->has('name'))
                                        ...
                                        <strong>{{ $errors->first('name') }}</strong>
                                                                ...
                                                                <div class="form-group{{ $errors->has('firstname') ? ' has-error' : '' }}">
                                                                    <label for="firstname"
                                                                           class="col-md-4 control-label">First
                                                                        Name</label>
                                                                    <div class="col-md-6">
                                                                        <input id="firstname" type="text"
                                                                               class="trackprogress form-control validate[required] text-input"
                                                                               name="firstname"
                                                                               value="<?php echo $editprofile[0]->firstname;?>"
                                                                               autofocus>
                                        ...
                                        <strong>{{ $errors->first('firstname') }}</strong>
                                                                ...
                                                                <div class="form-group{{ $errors->has('lastname') ? ' has-error' : '' }}">
                                                                    <label for="lastname"
                                                                           class="col-md-4 control-label">Last
                                                                        Name</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="lastname" type="text"
                                                                               class="trackprogress form-control validate[required] text-input"
                                                                               name="lastname"
                                                                               value="<?php echo $editprofile[0]->lastname;?>"
                                                                               autofocus>
                                                                ...
                                                                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="email" type="text"
                                                                               ...
                                                                               name="email"
                                                                               value="<?php echo $editprofile[0]->email;?>">
                                        ...
                                        <strong>{{ $errors->first('email') }}</strong>
                                                                ...
                                                                <div class="form-group{{ $errors->has('address_id') ? ' has-error' : '' }}">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div>Please fetch your address detail using your
                                                                            postcode
                                                                        </div>
                                        ...
                                        <strong>{{ $errors->first('address_id') }}</strong>
                                                                ...
                                                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="password" type="password"
                                                                               class="trackprogress form-control"
                                                                               name="password" value="">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <input id="phone" type="text"
                                                                               class="trackprogress form-control validate[required] text-input"
                                                                               value="<?php echo $editprofile[0]->phone;?>"
                                                                               name="phone">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div id='phoneVue'>
                                                                    <div>
                                                                        <h4 class="text-center page-title">
                                                                            ...
                                                                            <template v-if="action === 'new'"> Phone
                                                                                verification
                                                                            </template>
                                                                            <template v-if="action === 'unbind'"> Remove
                                                                                phone number
                                                                            </template>
                                                                            <template v-if="action === 'confirm'"> SMS
                                                                                Confirmation
                                                                            </template>
                                                                        </h4>
                                                                    </div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="control-label col-md-4 ">
                                                                            Phone Number
                                                                            <template v-if="action === 'confirm'">(<a
                                                                                        href="#"
                                                                                        @click.prevent="change">change</a>)
                                                                            </template>
                                                                        </label>
                                                                        <div class="col-md-6">
                                                                    ...
                                                                    <div v-if="action === 'confirm'" class="form-group"
                                                                         id="confirmation-code">
                                                                        <template v-if="action === 'confirm'">
                                                                            <label class="control-label col-md-4">Confirmation
                                                                                code</label>
                                                                            <div class="col-md-6">
                                                                                <input class="form-control" type="text"
                                                                                       v-model="code"/>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class=" col-md-6 col-md-offset-4">
                                                                            <a href="#" @click.prevent="send"
                                                                               class="btn btn-primary text">
                                                                                <template v-if="action === 'confirm'">
                                                                                    OK!
                                                                                </template>
                                                                                <template
                                                                                        v-else-if="action === 'unbind'">
                                                                                    Remove Phone Number
                                                                                </template>
                                                                ...
                                                                <div class="form-group{{ $errors->has('dob') ? ' has-error' : '' }}">
                                                                    <label for="dob"
                                                                           class="col-md-4 control-label">DOB</label>
                                                                    <div class="col-md-6">
                                                                        <?php
                                                                            ...
                                                                            @if($countries->count())
                                                                                @foreach($countries as $country)
                                                                                    <option value="{{$country->id}}"
                                                                                            <?php if($country->id == $editprofile[0]->nation_id){?> selected="selected" <?php } ?>>{{$country->name}}</option>
                                                                                @endforeach
                                                                            @endif
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div id="visa_no_field"
                                                                     class="form-group{{ $errors->has('visa_no') ? ' has-error' : '' }}">
                                                                    <label for="visa_no" class="col-md-4 control-label">Visa
                                                                        Number</label>
                                                                    <div class="col-md-6">
                                                                        <input id="visa_no" type="text"
                                                                               class="trackprogress form-control text-input"
                                                                               name="visa_no"
                                                                               value="<?php echo $editprofile[0]->visa_no;?>">
                                        ...
                                        <strong>{{ $errors->first('visa_no') }}</strong>
                                                                ...
                                                                <div id="niutr_no_field"
                                                                     class="form-group{{ $errors->has('niutr_no') ? ' has-error' : '' }}">
                                                                    <label for="niutr_no"
                                                                           class="col-md-4 control-label">NI or UTR
                                                                        Number</label>
                                                                    <div class="col-md-6">
                                                                        <input id="niutr_no" type="text"
                                                                               class="form-control text-input"
                                                                               name="niutr_no"
                                                                               value="<?php echo $editprofile[0]->niutr_no;?>">
                                        ...
                                        <strong>{{ $errors->first('niutr_no') }}</strong>
                                                                ...
                                                                <div class="form-group{{ $errors->has('work_category') ? ' has-error' : '' }}">
                                                                    <label for="work_category"
                                                                           class="col-md-4 control-label">Work
                                                                        Category</label>
                                                                    <div class="col-md-6">
                                                                        @if ($editprofile[0]->work_category == 1)
                                                                            {{ Form::radio('category', 1, true) }} Door
                                                                            Supervisor<br>
                                                                        @else
                                                                            {{ Form::radio('category', 1) }} Door
                                                                            Supervisor<br>
                                                                        @endif
                                                                        @if ($editprofile[0]->work_category == 2)
                                                                            {{ Form::radio('category', 2, true) }}
                                                                            Security Guard<br>
                                                                        @else
                                                                            {{ Form::radio('category', 2) }} Security
                                                                            Guard<br>
                                                                        @endif
                                                                        @if ($editprofile[0]->work_category == 3)
                                                                            {{ Form::radio('category', 3, true) }} Close
                                                                            Protection
                                                                        @else
                                                                            {{ Form::radio('category', 3) }} Close
                                                                            Protection
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                                <div class="form-group{{ $errors->has('sia_license') ? ' has-error' : '' }}">
                                                                    <label for="sia_licence"
                                                                           class="col-md-4 control-label">SIA
                                                                        Number</label>
                                                                    <div class="col-md-6">
                                                                        <input id="sia_licence" type="text"
                                                                               class="trackprogress form-control text-input"
                                                                               name="sia_licence"
                                                                               value="<?php echo old('sia_licence', $editprofile[0]->sia_licence);?>">
                                        ...
                                        <strong>{{ $errors->first('sia_licence') }}</strong>
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="passphoto"
                                                                           class="col-md-4 control-label">Passport
                                                                        photograph</label>
                                                                    <div class="col-md-6">
                                                                        <input type="file" id="passphoto"
                                                                               name="passphoto"
                                                                               class="trackprogress form-control">
                                        ...
                                        <strong>Document already uploaded</strong>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="visa_page"
                                                                           class="col-md-4 control-label">Visa page or
                                                                        Residency stamp</label>
                                                                    <div class="col-md-6">
                                                                        <input type="file" id="visa_page"
                                                                               name="visa_page"
                                                                               class="trackprogress form-control">
                                        ...
                                        <strong>Document already uploaded</strong>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="sia_doc" class="col-md-4 control-label">SIA
                                                                        License</label>
                                                                    <div class="col-md-6">
                                                                        <input type="file" id="sia_doc" name="sia_doc"
                                                                               class="trackprogress form-control">
                                        ...
                                        <strong>Document already uploaded</strong>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="address_proof"
                                                                           class="col-md-4 control-label">Proof of
                                                                        Address</label>
                                                                    <div class="col-md-6">
                                                                        <input type="file" id="address_proof"
                                                                               name="address_proof"
                                                                               class="trackprogress form-control">
                                        ...
                                        <strong>Document already uploaded</strong>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="alert alert-info" role="alert">
                                                                    After uploading, please take your Passport and SIA
                                                                    licence to the nearest post office for verification.
                                                                    This process will cost you £8.50.<br>
                                                                    Once certified, send a copy of the document to your
                                                                    our Licenced Partner. Visit the verification page
                                                                ...
                                                                <div class="checkbox">
                                                                    <label>
                                                                        <input type="checkbox" name="agree"
                                                                               class="trackprogress validate[required]"
                                                                               value="agree"/> I Agree to the GuardME
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-md-6 col-md-offset-4">
                                                                    <?php if(config('global.demosite') == "yes"){?>
                                                                    <button type="button"
                                                                            class="btn btn-primary btndisable">Update
                                                                    </button>
                                                                    <span class="disabletxt">( <?php echo config('global.demotxt');?>
                                                                        )</span>
                                                                    <?php } else { ?>
                                                            ...
                                                            <input type="hidden" name="currentpassphoto"
                                                                   value="<?php echo $editprofile[0]->passphoto;?>">
                                                            <input type="hidden" name="currentaddressproof"
                                                                   value="<?php echo $editprofile[0]->address_proof;?>">
                                                            <input type="hidden" name="currentsiadoc"
                                                                   value="<?php echo $editprofile[0]->sia_doc;?>">
                                                            <input type="hidden" name="currentvisapage"
                                                                   value="<?php echo $editprofile[0]->visa_page;?>">
                                                            <input type="hidden" name="currentpasspage"
                                                                   value="<?php echo $editprofile[0]->pass_page;?>">
                                                            <input type="hidden" name="usertype"
                                                                   value="<?php echo $editprofile[0]->admin;?>">
                                                            <input type="hidden" name="savepassword"
                                                                   value="<?php echo $editprofile[0]->password;?>">
                                                            <input type="hidden" name="id"
                                                                   value="<?php echo $editprofile[0]->id; ?>">
                                                            <input type="hidden" id="addresslat" name="addresslat"
                                                                   value="{{$address[0]->latitude}}">
                                                            <input type="hidden" id="addresslong" name="addresslong"
                                                                   value="{{$address[0]->longitude}}">
                            ...
                            <div class="tab-pane" id="sent">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6 contact_address">
                                        ...
                                        <p>
                                            <span class="lnr lnr-map-marker"></span> <?php echo ' ' . $shop[0]->address;?>
                                            <br>
                                            <?php echo $shop[0]->city;?> - <?php echo $shop[0]->pin_code;?><br>
                                            <?php echo $shop[0]->state;?><br>
                                            <?php echo $shop[0]->country;?></p>
                                        <p><span class="lnr lnr-clock"></span> <?php echo $stime;?>
                                            - <?php echo $etime;?></p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-6 working_day">
                                        ...
                                        <p><?php for ($i = 0; $i < $lev; $i++) {
                                                if ($sel[$i] == "0") echo "Sunday";
                                            }?></p>
                                        <p><?php for ($i = 0; $i < $lev; $i++) {
                                                if ($sel[$i] == "1") echo "Monday";
                                            }?></p>
                                        <p><?php for ($i = 0; $i < $lev; $i++) {
                                                if ($sel[$i] == "2") echo "Tuesday";
                                            }?></p>
                                        <p><?php for ($i = 0; $i < $lev; $i++) {
                                                if ($sel[$i] == "3") echo "Wednesday";
                                            }?></p>
                                        <p><?php for ($i = 0; $i < $lev; $i++) {
                                                if ($sel[$i] == "4") echo "Thursday";
                                            }?></p>
                                        <p><?php for ($i = 0; $i < $lev; $i++) {
                                                if ($sel[$i] == "5") echo "Friday ";
                                            }?></p>
                                        <p><?php for ($i = 0; $i < $lev; $i++) {
                                                if ($sel[$i] == "6") echo "Saturday";
                                            }?></p>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="rating">
                                            ...
                                            ?>
                                            <img src="<?php echo $url . $starpath;?>" class="star_rates"
                                                 alt="rated <?php if ($newrating->rating == "") {
                                                     echo "0";
                                                 } else {
                                                     echo $newrating->rating;
                                                 }?> stars" title="rated <?php if ($newrating->rating == "") {
                                                echo "0";
                                            } else {
                                                echo $newrating->rating;
                                            }?> stars"/> - &nbsp; <?php  echo $newrating->name;?>
