...
class JobsController extends Controller
{
    ...
    /*
     * to get jobs of the employer
     * */
    public function getEmployerJobs(){
        $id =auth()->user()->id ;
        $data = Job::where('created_by' , $id)->get() ;
    ...
    public function getSavedJobs(){
        $id =auth()->user()->id ;
        $data =   SavedJob::with('getFreelancerSavedJob')->where('user_id' , $id)->get();
    ...
    public function saveJob(Request $request){
        ...
        $saved_job->user_id =  $request->get('user_id');
        $saved_job->job_id =  $request->get('job_id');


        $isSaved = $saved_job->save();
        if ($isSaved) {
    ...
    /*
     *
     *  get applicants for a employer
     * */
    public function getApplicants(){
        $id =auth()->user()->id ;
        $freelance_jobs = DB::table('security_jobs')
